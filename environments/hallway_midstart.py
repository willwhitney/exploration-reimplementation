...
def velocity_4_offset_p5(time_limit=_DEFAULT_TIME_LIMIT, random=None,
             environment_kwargs=None):
  """Returns the easy point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
  task = Hallway(velocity=True, vel_gain=1.0, length=4, distractor_offset=0.5,
...
@SUITE.add('exploration')
def velocity_4_offset_1(time_limit=_DEFAULT_TIME_LIMIT, random=None,
             environment_kwargs=None):
  """Returns the easy point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
  task = Hallway(velocity=True, vel_gain=1.0, length=4, distractor_offset=1,
                 distractor_size=0.05, distractor_scale=1,
                 target_scale=0,
                 random=random)
  environment_kwargs = environment_kwargs or {}
...
@SUITE.add('exploration')
def velocity_4_offset_1p5(time_limit=_DEFAULT_TIME_LIMIT, random=None,
             environment_kwargs=None):
  """Returns the easy point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
  task = Hallway(velocity=True, vel_gain=1.0, length=4, distractor_offset=1.5,
                 distractor_size=0.05, distractor_scale=1,
                 target_scale=0,
                 random=random)
  environment_kwargs = environment_kwargs or {}
...
@SUITE.add('exploration')
def velocity_4_offset_2(time_limit=_DEFAULT_TIME_LIMIT, random=None,
             environment_kwargs=None):
  """Returns the easy point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
  task = Hallway(velocity=True, vel_gain=1.0, length=4, distractor_offset=2,
                 distractor_size=0.05, distractor_scale=1,
                 target_scale=0,
                 random=random)
  environment_kwargs = environment_kwargs or {}
